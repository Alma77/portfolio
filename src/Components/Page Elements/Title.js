...
const Title = () => {
    ...
    return (
        <div className="container text-white text-center pt-5 mt-5 border-bottom border-secondary">
            <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" width="100%" height="100%">

                {/* Background */}
                

                {/*<!-- Text using the #pattern in defs as the fill -->*/}
                <text x="50%" textAnchor="middle" y="50%" dy="0.4em" fill="url(#pattern)" fontFamily="sonos-logoregular" fontSize="10vh">Junior Software Engineer</text>

                <defs>
                   {/* Da gradient */}
                    <linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="0">
                        <stop offset="0%" style={{stopColor: "#E37313"}}/>
                        <stop offset="25%" style={{stopColor: "#E3C213"}}/>
                        <stop offset="50%" style={{stopColor: "#1FCFDE"}}/>
                        <stop offset="75%" style={{stopColor: "#1FDE2B"}}/>
                        <stop offset="100%" style={{stopColor: "#E37313"}}/>
                    </linearGradient>
                    ...
                    <rect x="0" y="0" width="150%" height="100%" fill="url(#gradient)">
                        <animate attributeType="XML" attributeName="x" from="0" to="150%" dur="15s" repeatCount="indefinite" />
                    </rect>
                    <rect x="-150%" y="0" width="150%" height="100%" fill="url(#gradient)">
                        <animate attributeType="XML" attributeName="x" from="-150%" to="0" dur="15s" repeatCount="indefinite" />
                    </rect>
                    </pattern>
                    ...
                    <font horizAdvX="1024">
                    <font-face fontFamily="sonos-logoregular" unitsPerEm="2048" ascent="1920" descent="-128" />
